 ...
 * Commentaire
 *
 * @ORM\Table("zcommentaire")
 * @ORM\Entity(repositoryClass="D2bg\BlogBundle\Entity\CommentaireRepository")
 */
class Commentaire
{
/**
* @ORM\ManyToOne(targetEntity="D2bg\BlogBundle\Entity\Article", inversedBy="commentaires");
