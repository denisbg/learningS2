...
use D2bg\BlogBundle\Form\ImageType;
...
class ImageController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('D2bgBlogBundle:Image')->findAll();
     ...
     * @Method("POST")
     * @Template("D2bgBlogBundle:Image:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('D2bgBlogBundle:Image')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("D2bgBlogBundle:Image:edit.html.twig")
     */
