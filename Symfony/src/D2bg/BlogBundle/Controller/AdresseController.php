...
use D2bg\BlogBundle\Entity\Adresse;
use D2bg\BlogBundle\Form\AdresseType;
...
class AdresseController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('D2bgBlogBundle:Adresse')->findAll();
     ...
     * @Method("POST")
     * @Template("D2bgBlogBundle:Adresse:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('D2bgBlogBundle:Adresse')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("D2bgBlogBundle:Adresse:edit.html.twig")
     */
