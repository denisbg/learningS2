...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\Dbg\\BlogBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\Dbg\\ProspectBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\D2bg\\BlogBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'Dbg\\BlogBundle\\Entity');
        $c->addDriver($b, 'Dbg\\ProspectBundle\\Entity');
        $c->addDriver($b, 'D2bg\\BlogBundle\\Entity');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('DbgBlogBundle' => 'Dbg\\BlogBundle\\Entity', 'DbgProspectBundle' => 'Dbg\\ProspectBundle\\Entity', 'D2bgBlogBundle' => 'D2bg\\BlogBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_9ac0cd772776cdac5710f234fdb42828698bdf61ec107cb521b5242a0132c374');
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('d.bouviergarzon@gmail.com');
        $a->setPassword('gGoogle31');
        $a->setAuthMode('login');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Dbg\\BlogBundle/Resources/views'), 'DbgBlog');
        $instance->addPath(($this->targetDirs[3].'\\src\\Dbg\\ProspectBundle/Resources/views'), 'DbgProspect');
        $instance->addPath(($this->targetDirs[3].'\\src\\D2bg\\BlogBundle/Resources/views'), 'D2bgBlog');
        $instance->addPath(($this->targetDirs[3].'\\src\\D2bg\\UserBundle/Resources/views'), 'D2bgUser');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('a6c89e893d51d8e8178efd98968af0ac9cd46d08');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'DbgBlogBundle' => 'Dbg\\BlogBundle\\DbgBlogBundle',
                'DbgProspectBundle' => 'Dbg\\ProspectBundle\\DbgProspectBundle',
                'D2bgBlogBundle' => 'D2bg\\BlogBundle\\D2bgBlogBundle',
                'D2bgUserBundle' => 'D2bg\\UserBundle\\D2bgUserBundle',
            ...
            'mailer_host' => NULL,
            'mailer_user' => 'd.bouviergarzon@gmail.com',
            'mailer_password' => 'gGoogle31',
            'locale' => 'en',
            'secret' => 'a6c89e893d51d8e8178efd98968af0ac9cd46d08',
            ...
            'kernel.secret' => 'a6c89e893d51d8e8178efd98968af0ac9cd46d08',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'd.bouviergarzon@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'gGoogle31',
            ...
            'webmaster' => 'Denis BOUVIER GARZON',
