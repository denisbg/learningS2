...
namespace PHPCRProxies\__CG__\Acme\DemoBundle\Document;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class UnitBlock extends \Acme\DemoBundle\Document\UnitBlock implements \Doctrine\Common\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'text', 'url', 'route', 'image', 'id', 'name', 'parentDocument', 'ttl', 'settings', 'createdAt', 'updatedAt', 'publishable', 'publishStartDate', 'publishEndDate', 'locale');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (UnitBlock $proxy) {
    ...
    public function setImage($url)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setImage', array($url));

        return parent::setImage($url);
    }
     ...
     * {@inheritDoc}
     */
    public function isSettingsValid(\Symfony\Component\Validator\ExecutionContextInterface $context)
    {
    ...
    public function setParentObject($parent)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setParentObject', array($parent));

        return parent::setParentObject($parent);
    }
    ...
    public function getParentObject()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getParentObject', array());
