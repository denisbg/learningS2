...
class MenuNode extends \Symfony\Cmf\Bundle\MenuBundle\Doctrine\Phpcr\MenuNode implements \Doctrine\Common\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'parent', 'locale', 'linkType', 'content', 'publishable', 'publishStartDate', 'publishEndDate', 'id', 'name', 'children', 'label', 'uri', 'route', 'attributes', 'childrenAttributes', 'linkAttributes', 'labelAttributes', 'extras', 'routeParameters', 'display', 'displayChildren', 'routeAbsolute');
        }
     ...
     * {@inheritDoc}
     */
    public function addChild(\Knp\Menu\NodeInterface $child)
    {
     ...
     * {@inheritDoc}
     */
    public function removeChild(\Knp\Menu\NodeInterface $child)
    {
    ...
    public function isDisplayable()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isDisplayable', array());
